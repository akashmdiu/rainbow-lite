<article class="post-card layout-1">
    <div <?php post_class(); ?>>
        ...
        <div class="post-content <?php if (!has_post_thumbnail()) { echo 'no-post-thumbnail'; } ?>">
            <?php 
                $RB_post_parts = get_theme_mod( 'RB_post_sortable_setting_01', array('RB_post_title', 'RB_post_meta', 'RB_post_excerpt', 'RB_post_footer') );
