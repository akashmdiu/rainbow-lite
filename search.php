        ...
        <div class="row">
            <div class="col-md-12">
                <div class="cover-content text-center">
                    <h1 class="post-title">
                        <?php echo esc_html(str_replace('[search_query]', RB_get_search_query(), get_theme_mod('RB_search_title_text_settings'))); ?>
                    </h1>
                    <h3 class="subtitle">
                        <?php echo esc_html(str_replace('[search_count]', search_result_count(), get_theme_mod('RB_result_found_text_settings'))); ?>
                    </h3>
                </div>
            </div>
        </div>
